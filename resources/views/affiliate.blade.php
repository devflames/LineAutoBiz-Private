...
<title>メルマガ配信スタンド『オートビズ』 アフィリエイトについて｜株式会社ビズクリエイト</title>
<link rel="shortcut icon" href="{{ asset("/../favicon/favicon.ico") }}">
<meta name="Keywords" content="オートビズ,ステップメール,アフィリエイト" />
<meta name="Description" content="メルマガ配信スタンド『オートビズ』 ステップメール配信対応|アフィリエイトの詳細とお申し込みについて" />

<!-- OGP（facebook用など）-->
<meta property="og:title" content="メルマガ配信スタンド『オートビズ』 ステップメール配信対応|アフィリエイトについて｜株式会社ビズクリエイト" />
<meta property="og:type" content="website" />
<meta property="og:url" content="https://www.biz-create.jp/html/affiliate.htm" />
<meta property="og:image" content="../images/hero_bg.jpg" />
<meta property="og:site_name" content="オートビズ" />
<meta property="og:description" content="メルマガ配信スタンド『オートビズ』 ステップメール配信対応｜アフィリエイトの詳細とお申し込みについて" />
<!-- /OGP（facebook用など） -->
...
<script type="text/javascript" src="{{ asset("/../function/js/page.js") }}"></script>
...
<li class="on"><h1>アフィリエイトパートナー</h1></li>
</ul>
<div class="leadTxt">
<h2>オートビズ アフィリエイトパートナー募集中！</h2>
</div>

<div class="color_bg">
<div class="conts_bg">
<div class="contsIn">
<h2 class="popTtl"><em>アフィリエイトについて</em></h2>
</div>
<div class="contsBox">
<div class="contsBoxIn">
<p>あなたのサイトやメルマガに設置したリンクから、当サイトにアクセスした方がサービスを申し込めば、あなたに報酬が支払われます。</p>
<p>アフィリエイトプログラムは国内大手アフィリエイトASP「A8.net」で運用しています。</p>
</div>
</div>
</div>
</div>
...
<div class="conts_bg">
<div class="contsIn">
<h2 class="popTtl"><em>報酬額について</em></h2>
</div>
<div class="contsBox">
<div class="contsBoxIn">
<span class="bold">報酬は、申込み１件につき</span>
<ul class="payment dot">
<li><span class="bold">7,000円</span></li>
</ul>
</div>
</div>
</div>
...
<div class="conts_bg">
<div class="contsIn">
<h2 class="popTtl"><em>90日の有効期限！</em></h2>
</div>
<div class="contsBox">
<div class="contsBoxIn">
<p>広告リンクが一度クリックされれば、 その後<span class="bold">90日以内の申込みであれば成果</span>となります！</p>
<p>初めてアクセスしてその場で申し込む方は稀でしょう。<br>
何度かアクセスして、じっくり検討して申し込まれる方が大半だと思います。</p>
</div>
</div>
</div>
</div>
...
<div class="conts_bg">
<div class="contsIn">
<h2 class="popTtl"><em>アフィリエイト登録の流れ</em></h2>
</div>
<div class="contsBox">
<div class="contsBoxIn">
<p><span class="bold">アフィリエイトプログラムへの参加は、国内大手アフィリエイトASP「A8.net」への登録が必要です。</span></p>

<dl class="flow">
<dt><em class="num"><span>1</span></em></dt>
<dd><a href="https://www.a8.net/"class="gLine" style="font-size:22px">A8.netに登録（無料）</a></dd>
</dl>
<dl class="flow">
<dt><em class="num"><span>2</span></em></dt>
<dd>「オートビズ」をプログラム検索</dd>
</dl>
<dl class="flow">
...
<dd><a href="https://www.a8.net/" target="_blank" class="regiBtn"><span><em class="spBr">A8.netで</em>アフィリエイトを始める</span></a>
</dd>
</dl>
<dl class="contactBtn clearfix">
<dt>オートビズに関する質問・疑問にもお答えします。お気軽にお問い合わせください。</dt>
<dd><a href="{{ url("inquired") }}" class="gBtn">お問い合わせ</a></dd>
</dl>
</div>
