...
<a href="{{ url("reason2.blade.php") }}" class="gBtn">選ばれる理由</a>
</div>
<!--[/reasonBlk]-->
...
<p><a href="{{ url("function2.blade.php") }}" class="gBtn">機能一覧</a></p>
...
<div id="modal" class="modal">
  <div class="modal-content">
    ...
    <a href="price20ad.blade.php?utm_source=modal&amp;utm_medium=banner&amp;utm_campaign=2309">
